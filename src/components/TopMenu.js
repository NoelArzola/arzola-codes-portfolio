...
export const TopMenu = ({ handleLogoTap }) => {
  return (
    <header>
      <nav className=" bg-[#0e7b10] pt-7 pb-6 rounded-bl-[2rem] rounded-br-[2rem] lg:rounded-none fixed w-full flex justify-center lg:justify-start lg:pl-10">
        <svg
          viewBox="0 0 88 24"
