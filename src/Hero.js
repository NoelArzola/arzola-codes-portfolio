  ...
  return (
    <header className="max-w-7xl mx-auto px-4 lg:px-24 py-12 lg:py-32 bg-gray-lightest">
      <div className="max-w-xl mx-auto">
        <h1 className="text-5xl text-center">hey, I'm Noel</h1>
        <p className="text-3xl text-centr mt-5">
        ...
        <div className="mt-2 flex justify-center">
          ...
          <a
            className="text-3xl text-link-blue hover:underline icon-chevronright ml-7"
            href="#contact"
          >
            Contact me
          </a>
