...
export const Spill = () => {
  return (
    <main
      className="bg-black relative h-screen max-h-screen overflow-hidden"
      role="main"
    >
      ...
      <TeaL />
      <div className="flex bg-blue-800 px-4 pt-5 pb-8 rounded-tl-3xl rounded-tr-3xl absolute w-full bottom-12">
        <img
          src={spillImage}
          alt=""
